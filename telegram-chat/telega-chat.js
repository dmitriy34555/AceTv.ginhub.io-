...
let token = `AAG0U8lBoSvedhk9hu9v9xJ4HlL2Vxj0VvU` //получаем при создании бота

let chatId = `1489587128` //получаем при вызове https://api.telegram.org/bot2030205061:AAG0U8lBoSvedhk9hu9v9xJ4HlL2Vxj0VvU/getupdates в браузере

let botId = `2030205061`
...
<div class="chat__input">
    ...
    <button class="chat__input__submit" aria-label="Отправить сообщение" style="background-image:url('./angle-up.svg')"></button>
</div>
